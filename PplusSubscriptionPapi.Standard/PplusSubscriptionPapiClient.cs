// <copyright file="PplusSubscriptionPapiClient.cs" company="APIMatic">
...
using System.Linq;
using APIMatic.Core;
using PplusSubscriptionPapi.Standard.Controllers;
using PplusSubscriptionPapi.Standard.Http.Client;
using PplusSubscriptionPapi.Standard.Utilities;

namespace PplusSubscriptionPapi.Standard
{
    /// <summary>
    /// The gateway for the SDK. This class acts as a factory for Controller and
    /// holds the configuration of the SDK.
    /// </summary>
    public sealed class PplusSubscriptionPapiClient : IConfiguration
    {
        ...
        private PplusSubscriptionPapiClient(
        ...
        /// <summary>
        /// Creates an object of the PplusSubscriptionPapiClient using the values provided for the builder.
        /// </summary>
        ...
        /// </summary>
        /// <returns> PplusSubscriptionPapiClient.</returns>
        internal static PplusSubscriptionPapiClient CreateFromEnvironment()
        {
            var builder = new Builder();

            string environment = System.Environment.GetEnvironmentVariable("PPLUS_SUBSCRIPTION_PAPI_STANDARD_ENVIRONMENT");
            string defaultHost = System.Environment.GetEnvironmentVariable("PPLUS_SUBSCRIPTION_PAPI_STANDARD_DEFAULT_HOST");
        ...
        {
            private Environment environment = PplusSubscriptionPapi.Standard.Environment.Production;
            ...
            {
                return new PplusSubscriptionPapiClient(
                    environment,
                    defaultHost,
                    httpCallback,
